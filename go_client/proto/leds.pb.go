...
type Animation struct {
	...
	Pause             int32      `protobuf:"varint,3,opt,name=pause,proto3" json:"pause"`
	Colours           []*RGB     `protobuf:"bytes,4,rep,name=colours,proto3" json:"colours"`
	Meta              []*RowMeta `protobuf:"bytes,5,rep,name=meta,proto3" json:"meta"`
	UpON              []*Step    `protobuf:"bytes,6,rep,name=upON,proto3" json:"upON"`
	UpOFF             []*Step    `protobuf:"bytes,7,rep,name=upOFF,proto3" json:"upOFF"`
	DownON            []*Step    `protobuf:"bytes,8,rep,name=downON,proto3" json:"downON"`
	DownOFF           []*Step    `protobuf:"bytes,9,rep,name=downOFF,proto3" json:"downOFF"`
	AnimationDuration int32      `protobuf:"varint,10,opt,name=animationDuration,proto3" json:"animationDuration"`
	OnTime            int32      `protobuf:"varint,11,opt,name=onTime,proto3" json:"onTime"`
	New               bool       `protobuf:"varint,12,opt,name=new,proto3" json:"new"`
	Rows              int32      `protobuf:"varint,13,opt,name=rows,proto3" json:"rows"`
	LedsPerRow        int32      `protobuf:"varint,14,opt,name=ledsPerRow,proto3" json:"ledsPerRow"`
}
...
type GetAnimationResponse struct {
	...
	Status    string     `protobuf:"bytes,1,opt,name=status,proto3" json:"status"`
	Animation *Animation `protobuf:"bytes,2,opt,name=animation,proto3" json:"animation"`
}
...
type Step struct {
	...
	PositionColour []*PositionColour `protobuf:"bytes,1,rep,name=positionColour,proto3" json:"positionColour"`
}
...
type PositionColour struct {
	...
	Colour   int32 `protobuf:"varint,2,opt,name=colour,proto3" json:"colour"`
}
...
type RowMeta struct {
	...
	Row       int32  `protobuf:"varint,1,opt,name=row,proto3" json:"row"`
...
type RGB struct {
	...
	Green int32 `protobuf:"varint,2,opt,name=green,proto3" json:"green"`
	Blue  int32 `protobuf:"varint,3,opt,name=blue,proto3" json:"blue"`
}
...
type RBPairingRequest struct {
	...
	TimestampRecieved int64  `protobuf:"varint,5,opt,name=timestampRecieved,proto3" json:"timestampRecieved"`
	TimestampPending  int64  `protobuf:"varint,6,opt,name=timestampPending,proto3" json:"timestampPending"`
	Rows              int32  `protobuf:"varint,7,opt,name=rows,proto3" json:"rows"`
	LedsPerRow        int32  `protobuf:"varint,8,opt,name=ledsPerRow,proto3" json:"ledsPerRow"`
}
...
type Device struct {
	...
	PairingId  string `protobuf:"bytes,5,opt,name=pairingId,proto3" json:"pairingId"`
	Rows       int32  `protobuf:"varint,6,opt,name=rows,proto3" json:"rows"`
	LedsPerRow int32  `protobuf:"varint,7,opt,name=ledsPerRow,proto3" json:"ledsPerRow"`
...
type AppPairingRequest struct {
	...
	UserMail string  `protobuf:"bytes,2,opt,name=userMail,proto3" json:"userMail"`
...
type DeviceControl struct {
	...
	Colour *RGB   `protobuf:"bytes,3,opt,name=colour,proto3" json:"colour"`
	New    bool   `protobuf:"varint,4,opt,name=new,proto3" json:"new"`
}
...
type GetDeviceControlResponse struct {
	...
	Status        string         `protobuf:"bytes,1,opt,name=status,proto3" json:"status"`
	DeviceControl *DeviceControl `protobuf:"bytes,2,opt,name=deviceControl,proto3" json:"deviceControl"`
}
...
type DeviceConnectionResponse struct {
	...
	DeviceControl *DeviceControl `protobuf:"bytes,2,opt,name=deviceControl,proto3" json:"deviceControl"`
	Animation     *Animation     `protobuf:"bytes,3,opt,name=animation,proto3" json:"animation"`
}
